    ...
    def map(self, value):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.debug(f"Transaction processed successfully. Fraud probability: {fraud_probability:.4f}")
                ...
                logger.warning(f"API call failed for transaction. Status: {response.status_code}, Response: {response.text}")
